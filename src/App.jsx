    ...
    try {
        ...
        if (permission === "granted") {
            const token = await getToken(messaging, {
                vapidKey: "BLIMB8wiN1qGoo9FgKbHUBHnZe-CFJrGH2I3rEDhQI-shQKUP8b77CF0KAqi_X-qDkLn_Pzw0ALGsqZUArZ326w",
            });

            // Construct the query for the tokens collection
            const tokenQuery = query(collection(db, "tokens"), where("email", "==", email));
